...
{
    public partial class F回放_按时间 : F控件, IV回放
    {
        private FGPS _FGPS;

        private List<M回放> _初始化参数;

        public F回放_按时间(List<M回放> 初始化参数)
        {
            H接口注册.设置();
            _初始化参数 = 初始化参数;
            InitializeComponent();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var __1倍速 = new { 速度 = 1, 描述 = "1倍" };
            var __5倍速 = new { 速度 = 5, 描述 = "5倍" };
            var __10倍速 = new { 速度 = 10, 描述 = "10倍" };
            var __30倍速 = new { 速度 = 30, 描述 = "30倍" };
            var __60倍速 = new { 速度 = 60, 描述 = "60倍" };
            var __150倍速 = new { 速度 = 150, 描述 = "150倍" };
            var __300倍速 = new { 速度 = 300, 描述 = "300倍" };
            var __600倍速 = new { 速度 = 600, 描述 = "600倍" };
            var __倍速列表 = new List<object> { __1倍速, __5倍速, __10倍速, __30倍速, __60倍速, __150倍速, __300倍速, __600倍速 };
            ...
            H容器.虚方法拦截<P回放_按时间>().处理视图(this, _初始化参数);
