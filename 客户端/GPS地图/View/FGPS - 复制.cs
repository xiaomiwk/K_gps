...
namespace GPS地图.View
{
    public partial class FGPS : F控件, IV地图
    {
        ...
        private Dictionary<ulong, Tuple<M经纬度, UInt64?>> _图标缓存 = new Dictionary<ulong, Tuple<M经纬度, ulong?>>();
        ...
        public List<ulong> 添加图标(List<M图标> __图标集)
        {
            ...
            __图标集.ForEach(__图标 =>
            {
                ...
                _图标缓存[__点标识] = new Tuple<M经纬度, UInt64?>(__经纬度, __线标识);
                __结果.Add(__点标识);
            });
            return __结果;
        }
